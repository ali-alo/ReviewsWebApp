...
namespace ReviewsWebApp.Data.Migrations
{
    ...
    [Migration("20230921111943_FixTagReviewRelationship")]
    partial class FixTagReviewRelationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReviewsWebApp.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReviewsWebApp.Models.Review", b =>
                {
                    ...
                    b.HasIndex("CreatorId", "ReviewItemId")
                        .IsUnique()
            ...
            modelBuilder.Entity("ReviewsWebApp.Models.UserRatedReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserLikedReviews", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ReviewsWebApp.Models.Comment", b =>
                {
                    ...
                    b.HasOne("ReviewsWebApp.Data.ApplicationUser", "User")
                        .WithMany("Comments")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ReviewTag", b =>
                {
                    ...
                    b.HasOne("ReviewsWebApp.Models.Tag", null)
                        .WithMany()
